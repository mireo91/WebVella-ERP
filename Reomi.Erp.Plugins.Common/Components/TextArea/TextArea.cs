...
[PageComponent(Label = "TextArea", Library = "Reomi", Description = "A textarea for plain text input. Will be cleaned and stripped from any web unsafe content", Version = "0.0.1", IconClass = "fas fa-paragraph")]
public class TextArea : PcFieldTextarea
{
  // protected ErpRequestContext ErpRequestContext { get; set; }
  // //
  public TextArea([FromServices] ErpRequestContext coreReqCtx): base(coreReqCtx)
  {
