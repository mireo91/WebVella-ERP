...
[PageComponent(Label = "HtmlEditor", Library = "Reomi", Description = "Provides the ability of entering and presenting an HTML code. Supports multiple input languages.", Version = "0.0.1", IconClass = "fas fa-code")]
public class HtmlEditor : PcFieldHtml
{
  // protected ErpRequestContext ErpRequestContext { get; set; }
  // //
  public HtmlEditor([FromServices] ErpRequestContext coreReqCtx): base(coreReqCtx)
  {
