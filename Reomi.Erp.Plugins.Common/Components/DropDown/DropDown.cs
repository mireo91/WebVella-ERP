...
public class DropDown : PcFieldSelect
{
  ...
  //   
  //   public class DropDownOptions : PcFieldSelect.PcFieldSelectOptions
  //   {
  ...
  // 	var options = DropDownOptions.CopyFromBaseOptions(baseOptions);
  // 	if (context.Options != null)
  // 	{
  // 		options = JsonConvert.DeserializeObject<DropDownOptions>(context.Options.ToString());
