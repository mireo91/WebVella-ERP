...
[PageComponent(Label = "Hidden Field", Library = "Reomi", Description = "Renders Hidden Input", Version = "0.0.1", IconClass = "far fa-eye-slash")]
public class HiddenField : PcFieldHidden
{
  // protected ErpRequestContext ErpRequestContext { get; set; }
  // //
  public HiddenField([FromServices] ErpRequestContext coreReqCtx): base(coreReqCtx)
  {
