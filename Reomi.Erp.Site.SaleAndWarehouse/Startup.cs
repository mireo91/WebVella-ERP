...
using System.Text;
using Reomi.Erp.Plugins.SaleAndWarehouse;
...
namespace Reomi.Erp.Site.SaleAndWarehouse
{
	...
	public class Startup
	{
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			{
				DefaultRequestCulture = new Microsoft.AspNetCore.Localization.RequestCulture(CultureInfo.GetCultureInfo("pl-PL"))
			});
			...
			.UseErpPlugin<SaleAndWarehousePlugin>()
			.UseErp()
			.UseErpMiddleware()
			.UseJwtMiddleware();
